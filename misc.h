...
//RY: start here
char DestAddrStr[INET_ADDRSTRLEN]; //TODO decide on number of bytes
#define IPADDY6(a) (inet_ntop(AF_INET6, (int *)&(a), (char*)DestAddrStr, INET6_ADDRSTRLEN), DestAddrStr)
//RY: end here
...
//RY: start
extern void status_handler6 (int signal);
//RY: end
