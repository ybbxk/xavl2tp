...
//RY: Used only when IP_ALLOCATIOn is defined
...
//RY: This function return the ip addr
/* this function is commented, just to skip as it is called ony when 
//IP_ALLOCATION is defined, for testing it has been disabled.
